...
def api_check():
    ...
    # Process text line by line (same function tumhare paas hai)
    output_html = process_text_line_by_line(text)

    # Sirf plain text / HTML return karo (sidebar mein show hoga)
    return output_html
